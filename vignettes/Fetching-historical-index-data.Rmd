---
title: "Analyzing B3 Index Data with rb3"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Analyzing B3 Index Data with rb3}
...
# Get the latest date
latest_date <- composition |>
  summarise(latest = max(update_date)) |>
  pull(latest)
```
...
```{r indices-for-stock, eval=FALSE}
