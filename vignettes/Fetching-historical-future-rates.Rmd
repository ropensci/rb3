...
In this analysis, we will work with futures contract settlement prices published daily by
B3 (Brasil, Bolsa, Balcão) - the Brazilian stock exchange and derivatives market.
...
```{r di1-futures-plot, fig.width=7, fig.height=5}
di1_futures |>
...
```{r dap-futures-plot, fig.width=7, fig.height=5}
dap_futures |>
...
```{r implied-inflation-plot, warning=FALSE, fig.width=7, fig.height=5}
infl_expec |>
...
```{r implied-inflation-F24, warning=FALSE, fig.width=7, fig.height=5}
df |>
