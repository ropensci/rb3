...
BD_Arbit <- MarketDataFWF$proto(expr={
  ...
  fields <- fields(
    ...
    field('preco_exercicio', 'Preço de exercício (opç)', width(13), to_numeric(dec='num_casas_decimais_2')),
    ...
    field('cot_ult_oferta_compra', 'Cotação da última oferta de compra do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_ult_oferta_compra')),
    ...
    field('cot_ult_oferta_venda', 'Cotação da última oferta de venda do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_ult_oferta_venda')),
    field('sinal_cot_primeiro_negocio', 'Sinal da cotação do primeiro negócio do dia', width(1)),
    field('cot_primeiro_negocio', 'Cotação do primeiro negócio do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_primeiro_negocio')),
    field('sinal_cot_menor_negocio', 'Sinal da cotação do menor negócio do dia', width(1)),
    field('cot_menor_negocio', 'Cotação do menor negócio do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_menor_negocio')),
    field('sinal_cot_maior_negocio', 'Sinal da cotação do maior negócio do dia', width(1)),
    field('cot_maior_negocio', 'Cotação do maior negócio do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_maior_negocio')),
    field('sinal_cot_med_negocios', 'Sinal da cotação média dos negócios do dia', width(1)),
    field('cot_med_negocios', 'Cotação média dos negócios do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_med_negocios')),
    ...
    field('cot_ult_negocio', 'Cotação do último negócio do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_ult_negocio')),
    ...
    field('cot_ult_negocio_anterior', 'Cotação do último negócio anterior', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_ult_negocio_anterior')),
    field('sinal_cot_fechamento', 'Sinal da cotação de fechamento do dia', width(1)),
    field('cot_fechamento', 'Cotação de fechamento do dia', width(8), to_numeric(dec='num_casas_decimais_2', sign='sinal_cot_fechamento')),
