  ...
  parts <- list(
    ...
    "Cotações históricas por papel-mercado" = list(
      ...
      fields = fields(
        ...
        field("preco_abertura", "Preço de abertura do papel", width(13), to_numeric(dec = 2)),
        field("preco_max", "Preço máximo do papel", width(13), to_numeric(dec = 2)),
        field("preco_min", "Preço mínimo do papel", width(13), to_numeric(dec = 2)),
        field("preco_med", "Preço médio do papel", width(13), to_numeric(dec = 2)),
        field("preco_ult", "Preço último negócio efetuado com o papel", width(13), to_numeric(dec = 2)),
        field("preco_melhor_oferta_compra", "Preço da melhor oferta de compra do papel", width(13), to_numeric(dec = 2)),
        field("preco_melhor_oferta_venda", "Preço da melhor oferta de venda do papel", width(13), to_numeric(dec = 2)),
        ...
        field("volume_titulos_negociados", "Volume total de títulos negociados neste papel", width(18), to_numeric(dec = 2)),
        field("preco_exercicio", "Preço de exercício para o mercado de opções ou valor do contrato para o mercado de termo secundário", width(13), to_numeric(dec = 2)),
